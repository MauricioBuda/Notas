...
let svgBell = `<svg class="img-campana-card" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bell" viewBox="0 0 16 16">
  ...
  if (tarea.estado === "Pendientes") {
        if (tarea.urgencia === "Alta") {
          ...
          <div id="${cardID}" class="cards borde_urgencia">
            ...
            <button class="button-campana-card">${svgBell}</button>
